...
export default function ProfileEdit() {
	...
	return (
		<section className="flex h-full w-full flex-col bg-white px-[5%] pb-3 text-center">
			...
			<form
				className="my-auto flex w-full max-w-mobile flex-col gap-2 px-[5%]"
			...
			>
				<div className="relative mx-auto aspect-square w-20 overflow-hidden rounded-full bg-gray-200">
					...
					<label
						...
						className="absolute bottom-0 left-0 w-full bg-[#232323]/50 py-1 text-white text-xs"
					>
						편집
					</label>
					<Input
				...
				<div className="pt-4">
					<label htmlFor="nickname" className="pb-2 font-semibold text-sm">
						프로필 이름
					</label>
					<Input
						inputType="text"
						id="nickname"
						name="nickname"
						className="w-full border-[#232323] border-b py-2 text-sm focus:outline-none"
				...
				<div>
					<label htmlFor="bio" className="block pb-2 font-semibold text-sm">
						내 프로필 소개
					</label>
					<TextArea
						id="bio"
						name="bio"
						className="h-auto w-full resize-none overflow-hidden border-[#232323] border-b py-2 text-sm focus:outline-none"
						value={bio}
