...
export function CafeAdd({ onOpen }: CafeAddProps) {
	return (
		<Button
			size="full"
			onClick={onOpen}
			className="justify-between bg-white from-white via-50% via-neutral-100 to-white py-4 text-[#232323] hover:bg-gradient-to-r focus:bg-gradient-to-r sm:py-3 sm:text-base md:text-lg lg:text-xl"
		>
