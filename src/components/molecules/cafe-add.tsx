...
export function CafeAdd({ onOpen }: CafeAddProps) {
  return (
    <Button
      size="full"
      onClick={onOpen}
      className="text-blk justify-between bg-white from-white via-neutral-100 via-50% to-white py-4 hover:bg-gradient-to-r focus:bg-gradient-to-r sm:py-3 sm:text-base md:text-lg lg:text-xl"
    >
