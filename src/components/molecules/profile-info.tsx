	...
	return (
		<div className="h-fit w-full bg-white px-3">
			<div className="flex flex-wrap items-center gap-6 px-3 py-2 pt-6 text-sm">
				<div className="aspect-square base:w-23 overflow-hidden rounded-full border bg-white sm:w-22 lg:w-24">
					<Image
				...
				<div className="flex w-full gap-3 py-1 text-responsive-xs">
					<Link
