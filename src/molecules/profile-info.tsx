...
export default function ProfileInfo (profileImageUrl: ProfileInfoProps) {
    return (
        <div className="w-full h-fit bg-white px-3 py-4">
            <div className="flex flex-wrap items-center gap-6 px-3 text-sm">
            <div className="bg-white w-22 aspect-square rounded-full border overflow-hidden">
                <Image 
                ...
                <div className="flex flex-col justify-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <Text size="base">팔로워 0</Text>
                        <Text size="base">팔로잉 0</Text>
                    </div>
                </div>
